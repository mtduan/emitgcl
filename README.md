...
|:-------------------:|:---------------------:|:-------------------:|:---------------------:|
| seaborn             | 0.11.2                | numpy               | 1.22.3                |
| scipy               | 1.9.1                 | tqdm                | 4.64.0                |
| torch_geometric     | 2.1.0.post1           | pandas              | 1.4.2                 |
| bioservices         | 1.11.2                | torch               | 1.12.0+cu102          |
| h5py                | 3.10.0                | scanpy              | 1.9.1                 |
| anndata             | 0.8.0                 | torchmetrics        | 0.9.3                 |
